...
allowed-tools: WebFetch, WebSearch, Read, Agent
...
> **Note:** When 3 or more competitors are requested, dispatch the `competitive-brief-orchestrator` agent for parallel processing. The agent is defined at `${CLAUDE_PLUGIN_ROOT}/agents/competitive-brief-orchestrator.md`.
